...
<div id='shelf' align="left">
    <table><tr>
	<td><a href="home.jsp" onclick="return changeHome();"><img src="images/bottomicon/home-blue.png" width="50px" height="60px"></a></td>
	<td><a href="myfriends.jsp" onclick="return changeFriends();"><img src="images/bottomicon/friends-grey.png" width="50px" height="60px"></a></td>
