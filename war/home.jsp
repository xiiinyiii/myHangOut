...
<html>
  <head>
    ...
    <script type="text/javascript" src="javascript/map/onload.js"></script>
    <script type="text/javascript" src="javascript/map/filter.js"></script>
  </head>
  <body>
        ...
        <div class="modal-body">
     	 ...
     	 <!-- This tab for photos -->
	        <div class="control-group">
				...
				<div class="control-group">
				  <label class="control-label" for="photoRegion">Location:</label>
				  <div class="controls">
      	...
      	<div class="tab-pane" id="event"><br>
	       <!-- This tab for events -->
			...
			<div class="control-group">
				  <label class="control-label" for="eventRegion">Location:</label>
				  <div class="controls">
